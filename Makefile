...
buildroot:
	...
	cd buildroot && git checkout 2026.08-rc1
...
fixup_uclibc: buildroot
	sed -i 's/UCLIBC_HAS_FPU=y/UCLIBC_HAS_FPU=n/g' buildroot/output/build/uclibc-*/.config
	sed -i 's/UCLIBC_HAS_FENV=y/UCLIBC_HAS_FENV=n/g' buildroot/output/build/uclibc-*/.config
	make -C buildroot/output/build/uclibc-*/ clean
